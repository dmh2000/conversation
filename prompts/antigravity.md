...
place the app and all its components in the 'antigravity' directory
...
Do not create the app yet. but when you do, place the app and its components in top level directory 'antigravity'. 
